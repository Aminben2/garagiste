            ...
            <div class="d-lg-flex align-items-center mb-4 gap-3">
                <div class="position-relative">
                    <form method="GET" action="{{ route('vehicles') }}">
                        <input type="text" name="search" class="form-control ps-5 radius-30" placeholder="Search Vehicle"
                ...
                <div class="ms-auto"><a href="{{ route('vehicles.create') }}"
                        class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add New Vehicle</a>
                </div>
            </div>
            @if (count($vehicles) > 0)
